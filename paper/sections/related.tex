...
backbone and skip contributions inside the U-Net at inference, which changes
the frequency content of samples without touching training.
...
\todo{sweep 2024--2026 venues for recent frequency-aware diffusion work; this
section was drafted without literature access and will be missing the newest
entries}
